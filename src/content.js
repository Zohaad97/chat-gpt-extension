  ...
  return (
    <main className="relative h-full w-full transition-width flex flex-col overflow-hidden items-stretch flex-1">
      <div className="flex-1 overflow-hidden">
        <div className="react-scroll-to-bottom--css-ftvmu-79elbk h-full dark:bg-gray-800">
          <div className="react-scroll-to-bottom--css-ftvmu-1n7m0yu">
                  ...
                  <div className="w-[30px] flex flex-col relative items-end">
                    <div className="relative flex">
                      ...
                      >
                        ...
                        <img
                          alt="Ali Memon"
                          src="/_next/image?url=https%3A%2F%2Flh3.googleusercontent.com%2Fa%2FAEdFTp56YT4ysQFSDpwPiSd7VDNoRsSrurEw6bGRUYSz%3Ds96-c&w=64&q=75"
                          decoding="async"
                          data-nimg="intrinsic"
                          className="rounded-sm"
                          srcSet="/_next/image?url=https%3A%2F%2Flh3.googleusercontent.com%2Fa%2FAEdFTp56YT4ysQFSDpwPiSd7VDNoRsSrurEw6bGRUYSz%3Ds96-c&w=32&q=75 1x, /_next/image?url=https%3A%2F%2Flh3.googleusercontent.com%2Fa%2FAEdFTp56YT4ysQFSDpwPiSd7VDNoRsSrurEw6bGRUYSz%3Ds96-c&w=64&q=75 2x"
                          style={{
                            position: "absolute",
                            inset: "0px",
                            boxSizing: "border-box",
                    ...
                    <div className="flex flex-grow flex-col gap-3">
                      <div className="min-h-[20px] flex flex-col items-start gap-4 whitespace-pre-wrap">
                        <div className="markdown prose w-full break-words dark:prose-invert dark">
                          <p>
                            Batching in databases refers to the process of
                            grouping multiple SQL statements together into a
                            single batch and sending them to the database server
                            at once. This can improve performance by reducing
                            the number of round trips between the application
                            and the database server, and by allowing the
                            database server to optimize the execution of the
                            statements as a group. Batching can be implemented
                            in various ways, such as using JDBC batching or
                            ORM-level batching.
                          </p>
                        </div>
                      </div>
        ...
        <form className="stretch mx-2 flex flex-row gap-3 pt-2 last:mb-2 md:last:mb-6 lg:mx-auto lg:max-w-3xl lg:pt-6">
          <div className="relative flex h-full flex-1 md:flex-col">
            ...
            <div className="flex flex-col w-full py-2 flex-grow md:py-3 md:pl-4 relative border border-black/10 bg-white dark:border-gray-900/50 dark:text-white dark:bg-gray-700 rounded-md shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]">
              <textarea
                tabIndex={0}
                data-id="ffa6265a-b923-4fd2-8184-4bbf9b936142"
                rows={1}
